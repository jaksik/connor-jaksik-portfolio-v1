        ...
        <Container>
          <Row className="no-gutters justify-content-center" style={{padding:`30px`}}>
              ...
              <div style={{maxWidth:`600px`}}>
                <p className="body-text">We'll identify your pain points, collaborate with you to define the real problems, and deliver digital solutions that support your business strategies.</p>
              </div>
              <div className="w-100"></div>
              <Link to="/services">
          ...
          <Row className="no-gutters justify-content-center" style={{padding:`30px`}}>
            <Col xs="12" md="4">
              ...
              <h5>Creative</h5>
              <p className="body-text">Building the functionality, tools, and assets to fashion a look, feel, tone and experience consistent with your brand and your mission.</p>
            </Col>
            <Col xs="12" md="4">
              <Img fluid={data.marketing.childImageSharp.fluid} className="landing-image"/>
              <h5>Marketing</h5>
              <p className="body-text">Creating seamless, reliable and effective solutions from engagement through post-purchase delight and back again.</p>
            </Col>
            <Col xs="12" md="4">
              <Img fluid={data.technology.childImageSharp.fluid} className="landing-image"/>
              <h5>Technology</h5>
              <p className="body-text">Smart, strategic thinking that provides a pathway and a plan to successfully grow your business and your brand.</p>
            </Col>
          </Row>
